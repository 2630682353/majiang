...
class player:
	...
	dui = 0; name = "";hu_pai_left_num = 0;list_dui = [];win_score = 100; money = 1000;
	def __init__(self):
...
#					continue
	...
	def caculate_score(self):
		...
		if self.ding == 't':
			...
			if num_nen_peng > 0:
#				if num_nen_peng == 4 and len(self.user_desk.list_tuple) < 26 or num_nen_peng == 5:
#					score = num_nen_peng + nodui_score
#				else:
					score = num_nen_peng + nodui_score + 1   #计算分数
			else:
				score = nodui_score
		if self.ding == 'w':
...
def test_spec():
	p1 = player();
	p1.name = 'pa'
	p1.list_t=[1,1,2,2,4,5,6]
	p1.list_b=[1,1,4,4,7,7,7]
	p1.list_ding = ['t','b','w','w']
	#p1.have_peng.append(18)
	#p1.have_peng.append(19)
	p1.user_desk.list_river.append(3)
	p1.user_desk.list_river.append(3)
	p1.user_desk.list_river.append(3)
	p1.user_desk.list_river.append(3)
	p1.user_desk.list_river.append(1)
	p1.user_desk.list_river.append(1)
	p1.user_desk.list_river.append(2)
	#p1.user_desk.list_river.append(2)
	p1.user_desk.list_river.append(21)
	p1.user_desk.list_river.append(21)
	p1.user_desk.list_river.append(24)
	p1.user_desk.list_river.append(24)
	for i in range(0,21):
